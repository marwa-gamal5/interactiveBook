...
import image from '../../assets/Book/21.jpg';
import image2 from '../../assets/Book/22.jpg';
...
function Page11() {
    ...
    const getEdits = () => {
        ...
        const pageIndex = data.findIndex(item => item.page_id === 11);
        if (pageIndex != -1) {
    ...
    const [pageId, setPageId] = useState(11); // Use state for page_id
    // const [jsonData, setJsonData] = useState("");
