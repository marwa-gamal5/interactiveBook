...
import image from '../../assets/Book/17.jpg';
import image2 from '../../assets/Book/18.jpg';
...
function Page9() {
    ...
    const getEdits = () => {
        ...
        const pageIndex = data.findIndex(item => item.page_id === 9);
        if (pageIndex != -1) {
    ...
    const [pageId, setPageId] = useState(9); // Use state for page_id
    // const [jsonData, setJsonData] = useState("");
