...
import image from '../../assets/Book/29.jpg';
import image2 from '../../assets/Book/30.jpg';
import styles from '../page15/page15.module.css';
...
function Page15() {
    ...
    const getEdits = () => {
        ...
        const pageIndex = data.findIndex(item => item.page_id === 15);
        if (pageIndex != -1) {
    ...
    const [pageId, setPageId] = useState(15); // Use state for page_id
    // const [jsonData, setJsonData] = useState("");
