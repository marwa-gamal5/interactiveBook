...
import image from '../../assets/Book/19.jpg';
import image2 from '../../assets/Book/20.jpg';
...
function Page10() {
    ...
    const getEdits = () => {
        ...
        const pageIndex = data.findIndex(item => item.page_id === 10);
        if (pageIndex != -1) {
    ...
    const [pageId, setPageId] = useState(10); // Use state for page_id
    // const [jsonData, setJsonData] = useState("");
