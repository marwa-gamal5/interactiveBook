...
import image from '../../assets/Book/25.jpg';
import image2 from '../../assets/Book/26.jpg';
import styles from '../page13/page13.module.css';
...
function Page13() {
    ...
    const getEdits = () => {
        ...
        const pageIndex = data.findIndex(item => item.page_id === 13);
        if (pageIndex != -1) {
    ...
    const [pageId, setPageId] = useState(13); // Use state for page_id
    // const [jsonData, setJsonData] = useState("");
