...
import image from '../../assets/Book/12.jpg';
...
<i className="fa-solid fa-volume-high" onClick={handleAudioClick} style={{ position: 'absolute', top: '140px', left: '20%', transform: 'translateX(-50%)', zIndex: '9999', cursor: 'pointer' ,fontSize:'50px' , color: '#074773' }}></i>
          <img src={image} alt="page4" style={{ position: 'absolute' }} className={`p-0 m-0  w-100`} />
            {/* Audio player */}
            {isAudioPlaying && (
                <audio controls style={{ position: 'absolute', top: '33%', left: '40%', transform: 'translate(-50%, -50%)', zIndex: '9998' }}>
