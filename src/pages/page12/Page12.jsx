...
import image from '../../assets/Book/23.jpg';
import image2 from '../../assets/Book/24.jpg';
import styles from '../page12/page12.module.css';
...
function Page12() {
    ...
    const getEdits = () => {
        ...
        const pageIndex = data.findIndex(item => item.page_id === 12);
        if (pageIndex != -1) {
    ...
    const [pageId, setPageId] = useState(12); // Use state for page_id
    // const [jsonData, setJsonData] = useState("");
